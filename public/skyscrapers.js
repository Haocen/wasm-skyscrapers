...
function integrateWasmJS() {
  ...
  var wasmTextFile = 'skyscrapers.wast';
  var wasmBinaryFile = 'skyscrapers.wasm';
  var asmjsCodeFile = 'skyscrapers.temp.asm.js';
...
var real__addTwo = asm["_addTwo"]; asm["_addTwo"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real__addTwo.apply(null, arguments);
};

var real__buildSkyScrapers = asm["_buildSkyScrapers"]; asm["_buildSkyScrapers"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real__buildSkyScrapers.apply(null, arguments);
};
...
var real__powerEvery = asm["_powerEvery"]; asm["_powerEvery"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real__powerEvery.apply(null, arguments);
};
...
var _addTwo = Module["_addTwo"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["_addTwo"].apply(null, arguments) };
var _buildSkyScrapers = Module["_buildSkyScrapers"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["_buildSkyScrapers"].apply(null, arguments) };
...
var _powerEvery = Module["_powerEvery"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["_powerEvery"].apply(null, arguments) };
